<template>
  <div class="featured">
    <title-view :label="titleText" :btn="btnText" v-if="titleVisible && data && data.length > 0" @onClick='featuredList'></title-view>
        ...
        .featured-item {
          ...
          .content-wrapper {
            ...
            .author {
              ...
              max-height:px2rem(21) !important;
              line-height:px2rem(21)!important;
            }
            .category {
              margin-top: px2rem(5);
              max-height:px2rem(20) !important;
